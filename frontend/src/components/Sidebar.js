    ...
    <>
      <nav className="md:left-0 md:block bg-gray-800 md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          {/* Brand */}
          <Link
            className="md:block text-left md:pb-2 text-white mr-0 inline-block whitespace-nowrap text-lg uppercase font-bold p-4 px-0"
            to="/"
          >
            Nexus
          </Link>
          ...
          >
            ...
            {/* Heading */}
            <h6 className="md:min-w-full text-white hover:text-pink-600 text-xs uppercase font-bold block pt-1 pb-4 no-underline">
              Documentation
            </h6>
          </div>
        </div>
